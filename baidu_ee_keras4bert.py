...
-------------------------------------------------
   File Name：        baidu_ee_keras4bert
   Description :
   Author :           heyouxin
   Create date：      2021/5/15
   Latest version:    v1.0.0
-------------------------------------------------
   Change Log:
#-----------------------------------------------#
    v1.0.0            hyx        2021/5/15
    1.
#-----------------------------------------------#
-------------------------------------------------
...
# bert配置
config_path = '../pretrain_model/chinese_L-12_H-768_A-12/config.json'
checkpoint_path = '../pretrain_model/chinese_L-12_H-768_A-12/model.ckpt'
...
if __name__ == '__main__':
    ...
    predict_to_file('./datasets/DuEE/dev.json', 'dev_pred.json')
